...
# class Maid:
#     def __init__(self, name, rating, start_time, end_time):
#         self.name = name
#         self.rating = rating
...
# maids = [
#     Maid("Maid-1", 3.5, "09:00", "11:00"),
#     Maid("Maid-2", 4.5, "10:00", "13:00")
# ]
...
#     if booking_time:
#         available_maids = [maid for maid in maids if maid.start_time <= booking_time <= maid.end_time]
#         sorted_maids = sorted(available_maids, key=lambda x: x.rating, reverse=True)
#         return render_template("index.html", maids=sorted_maids)
...
#         available_maids = [maid for maid in maids if maid.start_time <= booking_time <= maid.end_time]
#         sorted_maids = sorted(available_maids, key=lambda x: x.rating, reverse=True)
#         return render_template("index.html", maids=sorted_maids, booking_time=booking_time)
#     return render_template("index.html")

# @app.route("/book", methods=["POST"])
# def book():
#     maid_name = request.form.get("maid_name")
#     booking_time = request.form.get("booking_time")
#     bookings.append((maid_name, booking_time))
